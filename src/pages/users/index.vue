...
const menuModel = ref([
  ...
  {
    label: 'Delete', icon: 'pi pi-fw pi-search', command: () => {
    ...
    >
      ...
      <Column field="actions" header="Actions">
        <template #body="slotProps">
          <router-link :to="{name: 'users.edit', params: {id: slotProps.data.id}}">Edit</router-link>
          <a href="#" @click.prevent="dispatchAction('deleteItem', slotProps.data.id)">Delete</a>
        </template>
      </Column>
    </DataTable>
